...
def usage(exitCode=None):
	print """hdfWaterfallDRSU.py - Read in a DRX file directly from a DRSU and create a 
collection of time-averaged spectra.  These spectra are saved to a HDF5 file called 
<filename>-waterfall.hdf5.

Usage: hdfWaterfallDRSU.py [OPTIONS] md_device file_tag
...
def main(args):
	...
	if offset != 0:
		drxFile.fh.seek(offset*drx.FrameSize, 1)
	...
	while True:
		...
		if cOffset is 0:
			break
		drxFile.fh.seek(cOffset*drx.FrameSize, 1)
