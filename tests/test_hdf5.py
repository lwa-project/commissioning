...
class drspec_tests(unittest.TestCase):
    def setUp(self):
        ...
        if os.path.getsize(_FILENAME) < 0.99*int(_SIZE_MB)*1024*1024:
...
if run_scripts_tests:
    _SCRIPTS = ['../DRX/HDF5/calculateSK.py', '../DRX/HDF5/decimateHDF.py 2', 
                '../DRX/HDF5/dedisperseHDF.py 4.0', '../DRX/HDF5/linear2stokes.py']
    _SCRIPTS.sort()
